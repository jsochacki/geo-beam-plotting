function varargout = mygeoplot3(gl, lat, lon, height, varargin)
%mygeoplot3 Geographic globe plot
%
%   mygeoplot3(gl,lat,lon,height) plots a 3-D line in a geographic globe
...
%  
%   mygeoplot3(gl,lat,lon,height,LineSpec) uses a LineSpec to specify the
%   line style, marker symbol, and color for the line. By default, mygeoplot3
%   draws a solid line, with no markers, using colors specified by the
%   geoglobe ColorOrder property.
%  
%   mygeoplot3(___,Name,Value) specifies line properties using one or more
%   Name,Value pair arguments.
% 
%   mygeoplot3(___,'HeightReference',heightReferenceValue, __) specifies the
...
% 
%   H = mygeoplot3(___) returns a scalar map.graphics.primitive.Line object. Use
%   H to modify the properties of the object after it is created.
% 
%   The vertices can be NaN-delimited to indicate line segments.
% 
%   A Line object created by mygeoplot3 can be re-parented to a different
...
%   fig = uifigure;
%   gl = geoglobe(fig);
%   h = mygeoplot3(gl,lat,lon,height,'c')
%
